...
if __name__ == "__main__":
    print "To determine the amount of data increase or decrease, select:."
    interface_num = input("How many interface do you want to check? : ")
    seconds = input("How many seconds do you want to check the data increase or decrease?? : ")
    (port_types,start_input_pks, end_input_pks, change_input_pks, start_output_pks, end_output_pks, change_output_pks) = get_rate_change(
interface_num, get_byte_num("M"), seconds)
    
    print "Input Rate(bps)"
    print "start value : ", start_input_pks
    print "end value : ", end_input_pks
    print "change value : ", change_input_pks
    print "=" * 70
    
    print "Output Rate(bps)"
    print "start value : ", start_output_pks
    print "end value : ", end_output_pks
    print "change value : ", change_output_pks
    print "=" * 70
